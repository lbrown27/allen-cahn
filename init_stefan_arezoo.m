...
refinement_factor = 1; % adjusts the thickness of the interface and appropriately adjusts the number of points.

pc.N = refinement_factor*2000;
pc.l = 1;
pc.dx = pc.l / (pc.N);
pc.sigma_c = .0317;
%pc.sigma_c = .0001325;
pc.ksi_c = (1/refinement_factor)*1.5*7.0711e-04*1000/pc.N;% from arezoo, initial multiple term added by me
...
pc.gas_pedal = 2* pc.gamma * pc.mu / pc.ksi_c;
